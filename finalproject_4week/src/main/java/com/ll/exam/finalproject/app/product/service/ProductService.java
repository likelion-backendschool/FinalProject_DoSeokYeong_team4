package com.ll.exam.finalproject.app.product.service;
...
import com.ll.exam.finalproject.app.postTag.service.PostTagService;
import com.ll.exam.finalproject.app.postkeyword.entity.PostKeyword;
import com.ll.exam.finalproject.app.postkeyword.service.PostKeywordService;
import com.ll.exam.finalproject.app.product.entity.Product;
import com.ll.exam.finalproject.app.product.repository.ProductRepository;
import com.ll.exam.finalproject.app.productTag.entity.ProductTag;
import com.ll.exam.finalproject.app.productTag.service.ProductTagService;
...
public class ProductService {
    ...
    public Optional<Product> findForPrintById(long id, Member member) {
        Optional<Product> opProduct = findById(id);

        if (opProduct.isEmpty()) return opProduct;

        loadForPrintData(opProduct.get(), member);
